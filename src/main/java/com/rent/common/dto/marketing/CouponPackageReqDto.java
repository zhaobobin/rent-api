...
public class CouponPackageReqDto extends Page implements Serializable {
    ...
    @Schema(description = "优惠券模版ID，多个以,分割")
    ...
    @Schema(description = "DelayDayNum")
