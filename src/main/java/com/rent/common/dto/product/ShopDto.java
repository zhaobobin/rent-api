...
public class ShopDto implements Serializable {
     ...
     * 
     */
    @Schema(description = "店铺是否被冻结 0未冻结 1冻结")
     ...
     *
     */
    @Schema(description = "是否需要平台电话审核 0否 1是")
     ...
     *
     */
    @Schema(description = "是否开启自动分配审核人员 0否 1是")
