...
public class StageOrderPayJob extends QuartzJobBean {

    private UserOrdersTaskService userOrdersTaskService;

    public StageOrderPayJob(UserOrdersTaskService userOrdersTaskService) {
        this.userOrdersTaskService = userOrdersTaskService;
    }

    @Override
    protected void executeInternal(JobExecutionContext jobExecutionContext) throws JobExecutionException {
        userOrdersTaskService.stageOrderPay();
    }
}
