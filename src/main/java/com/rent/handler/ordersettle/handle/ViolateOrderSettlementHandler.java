...
@Slf4j
@Component
public class ViolateOrderSettlementHandler extends AbstractOrderSettlementHandler {

    private OrderSettlementDao orderSettlementDao;

    public ViolateOrderSettlementHandler(OrderSettlementDao orderSettlementDao) {
