 ...
 */
public interface AlipayTradePayDao extends IBaseDao<AlipayTradePay> {
     ...
     * @return 支付记录
     */
    AlipayTradePay getOneByTradeNo(String tradeNo, EnumAliPayStatus aliPayStatus);
     ...
     * @return
     */
    AlipayTradePay getByTradeNoIfAllFailed(String outTradeNo);
